...
async function seed() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We provide a 90-day free replacement guarantee. If a placement doesn't work out for any reason, we will match you with a new professional at no additional placement cost.",
      pages: ['home', 'how-it-works'],
      order: 2,
    },
    {
    ...
    data: {
      ...
      rolePricing: [
        ...
        },
        {
          ...
          details:
            'General house management including cleaning, laundry, ironing, and basic cooking.',
        },
        {
          role: 'Caregiver',
          low: 20000,
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      neighborhoods: [
        { name: 'Kilimani', workers: 186, latitude: -1.2921, longitude: 36.782, popularServices: [{ service: 'Nannies' }, { service: 'Housekeepers' }] },
        { name: 'Lavington', workers: 142, latitude: -1.28, longitude: 36.767, popularServices: [{ service: 'Live-in Nannies' }, { service: 'Gardeners' }] },
        { name: 'Westlands', workers: 203, latitude: -1.2674, longitude: 36.807, popularServices: [{ service: 'Housekeepers' }, { service: 'Deep cleaning' }] },
        ...
        { name: 'Kileleshwa', workers: 158, latitude: -1.283, longitude: 36.778, popularServices: [{ service: 'Day Nannies' }, { service: 'Cleaners' }] },
        { name: 'South B', workers: 94, latitude: -1.313, longitude: 36.845, popularServices: [{ service: 'Housekeepers' }, { service: 'Deep cleaning' }] },
        { name: 'South C', workers: 87, latitude: -1.303, longitude: 36.829, popularServices: [{ service: 'Cleaners' }, { service: 'Housekeepers' }] },
        { name: 'Syokimau', workers: 73, latitude: -1.348, longitude: 36.928, popularServices: [{ service: 'Housekeepers' }, { service: 'Deep cleaning' }] },
        { name: 'Ruaka', workers: 112, latitude: -1.204, longitude: 36.765, popularServices: [{ service: 'Nannies' }, { service: 'Housekeepers' }] },
        { name: 'Parklands', workers: 131, latitude: -1.263, longitude: 36.815, popularServices: [{ service: 'Caregivers' }, { service: 'Housekeepers' }] },
  ...
  const team = [
    { name: 'Alexander', role: 'Co-Founder', bio: 'Co-founded MyNanny in 2019.', order: 1 },
    { name: 'James', role: 'Co-Founder', bio: 'Co-founded MyNanny in 2019.', order: 2 },
  ]
